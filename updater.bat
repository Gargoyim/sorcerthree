...
IF NOT EXIST "mods/immersive-portals-1.4.7-mc1.18.2-fabric.jar" (
    ...
    powershell -Command "Expand-Archive -Path immersive.zip -DestinationPath %cd%"
...
IF NOT EXIST "mods/indium-1.0.6+mc1.18.2.jar" (
    ...
    powershell -Command "Expand-Archive -Path indium.zip -DestinationPath %cd%"
...
IF NOT EXIST "mods/Pehkui-3.3.1+1.14.4-1.19.jar" (
    ...
    powershell -Command "Expand-Archive -Path pehkui.zip -DestinationPath %cd%"
